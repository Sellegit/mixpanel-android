...
namespace Com.Mixpanel.Android.Mpmetrics {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='GCMReceiver']"
	[global::Android.Runtime.Register ("com/mixpanel/android/mpmetrics/GCMReceiver", DoNotGenerateAcw=true)]
	public partial class GCMReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/mixpanel/android/mpmetrics/GCMReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (GCMReceiver); }
		}

		protected GCMReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='GCMReceiver']/constructor[@name='GCMReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public GCMReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (GCMReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Mixpanel.Android.Mpmetrics.GCMReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Mixpanel.Android.Mpmetrics.GCMReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='GCMReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
