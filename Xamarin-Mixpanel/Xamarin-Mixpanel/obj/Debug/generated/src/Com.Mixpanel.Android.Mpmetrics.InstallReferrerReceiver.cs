...
namespace Com.Mixpanel.Android.Mpmetrics {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='InstallReferrerReceiver']"
	[global::Android.Runtime.Register ("com/mixpanel/android/mpmetrics/InstallReferrerReceiver", DoNotGenerateAcw=true)]
	public partial class InstallReferrerReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/mixpanel/android/mpmetrics/InstallReferrerReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InstallReferrerReceiver); }
		}

		protected InstallReferrerReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='InstallReferrerReceiver']/constructor[@name='InstallReferrerReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public InstallReferrerReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (InstallReferrerReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Mixpanel.Android.Mpmetrics.InstallReferrerReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Mixpanel.Android.Mpmetrics.InstallReferrerReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mixpanel.android.mpmetrics']/class[@name='InstallReferrerReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
